...
Please note that the **Manager** attribute is currently not supported by iProva. If it appears in the default mapping, make sure to remove this attribute from the mapping by clicking the **Delete** button.
